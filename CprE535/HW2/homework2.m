...
ReferenceMode('averagePRNU', 'FF', 'Nexus6', 'FF', 'sigma', 0);

% Build single PRNU for each NI image
ReferenceMode('singlePRNU', 'NI', 'Nexus6', 'NI', 'sigma', 0);

% Correlate PRNU for each NI image with the average PRNU from FF
CorrelateMode('FF_out', 'Nexus6_FF_AVE_S_L.mat');
